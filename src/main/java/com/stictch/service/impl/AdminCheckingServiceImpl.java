...
public class AdminCheckingServiceImpl implements AdminCheckingService {
    ...
    @Override
    public AdminChecking insert(AdminChecking adminChecking) {
        return null;
    }

    @Override
    public AdminChecking update(AdminChecking adminChecking) {
        return null;
    }

    @Override
    public boolean deleteById(Long adminCheckId) {
        return false;
    }
}
